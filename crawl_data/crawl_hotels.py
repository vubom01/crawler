    ...
    request = [
        {
            "variables": {
                ...
                "clientType": "DESKTOP",
                "productId": "Hotels",
                "pageviewId": "LIT@VUhlnOQ91I5hyuoR0w5m",
                "sessionId": "65DA503E00374B52B967B3A4F9CEA743",
                "amenityLimit": 5,
                "route": {
                    "page": "HotelsFusion",
                    "params": {
            ...
            "extensions": {
                "preRegisteredQueryId": "b7d064890dad5054"
            }
        }
    ]
...
headers = {
    ...
    'referer': 'https://www.tripadvisor.com.vn/Hotels-g298085-Da_Nang-Hotels.html',
